...
window.jwplayer = (function (t) {
  function e(e) {
    for (var n, i, o = e[0], u = e[1], a = 0, s = []; a < o.length; a++)
      (i = o[a]), Object.prototype.hasOwnProperty.call(r, i) && r[i] && s.push(r[i][0]), (r[i] = 0);
      ...
      it = function (t, e, n) {
        ...
        return function () {
          ...
          return (
            ...
            (i = arguments),
            s <= 0
              ? (clearTimeout(u), (u = null), (a = Tt), (o = t.apply(r, i)), (r = i = null))
    ...
    var a = {
        ...
        get version() {
          return (function (t, e) {
            ...
            if (t.chrome)
              n =
                -1 !== e.indexOf("Chrome") ? e.substring(e.indexOf("Chrome") + 7) : e.substring(e.indexOf("CriOS") + 6);
    ...
    function v(t) {
      for (var e = t.attributes, n = e.length; n--; ) {
        ...
        if ((/^on/.test(r) && t.removeAttribute(r), /href/.test(r))) {
          var i = e[n].value;
          /javascript:|javascript&colon;/.test(i) || !h.test(i)
            ? t.removeAttribute(r)
    ...
    function F(t, e, n) {
      if ((void 0 === n && (n = {}), h.test(t))) {
        ...
        (r.href = t),
          ...
          (r = v(Object(i.j)(r, n))),
          u.Browser.firefox
            ? r.dispatchEvent(new MouseEvent("click", { bubbles: !0, cancelable: !0, view: window }))
            : r.click();
      }
    }
    function I() {
      ...
      return (
        (!!t && ("landscape-primary" === t.type || "landscape-secondary" === t.type)) ||
  ...
  function (t, e, n) {
    ...
    function l(t, e) {
      if ((Object(i.u)(t) && (t = parseInt(t.toString())), Object(i.u)(t) || !isFinite(t) || (t <= 0 && !e)))
        return "00:00";
      var n = t < 0 ? "-" : "";
      t = Math.abs(t);
  ...
  function (t, e, n) {
    ...
    function c(t, e) {
      ...
      return (
        (n.type = "text/javascript"), (n.charset = "utf-8"), (n.async = !0), (n.timeout = e || 45e3), (n.src = t), n
      );
    }
        ...
        return (
          (e.setupPlugin = function (t) {
            ...
            return e
              ? (e.url !== t &&
                  Object(a.a)(
                    'JW Plugin "' + Object(i.c)(t) + '" already loaded from "' + e.url + '". Ignoring "' + t + '."',
                  ),
                e.promise)
    ...
    e.b = function (t) {
      ...
      (this.edition = function () {
        ...
        (this.error = function () {
          var r;
          return (
            void 0 === t ? (r = 100011) : "invalid" !== e && n ? this.duration() < 0 && (r = a) : (r = 100012),
  ...
  function (t, e, n) {
    ...
    var r =
      "8.21.1+commercial_v8-21-1.468.commercial.d00f7e2.hlsjs..hlsjsalt..jwplayer.7325f8e.dai.1f98a0b.freewheel.1f60863.googima.1281534.googimanvmp.106f6b4.headerbidding.ed9ac5e.vast.5594430.analytics.920ae01.gapro.141397a";
  },
  function (t, e, n) {
    "use strict";
    var r = n(0),
  ...
  function (t, e, n) {
              ...
              if (
                ...
                if (!t.directSelect || c === e) {
                  ...
                  if (
                    ...
                    "mousedown" === s
                      ? (C(t, "window", "mousemove", o, r), C(t, "window", "mouseup", u))
                      : "touchstart" === s &&
                        (C(t, "window", "touchmove", o, r),
      ...
      if (!t.handlers.select) {
        ...
        w(t, "select"),
          A(t, "select", function (n) {
            var r = n.target;
            (t.directSelect && r !== e) ||
              (n.isPrimary && "BUTTON" === r.tageName && r.focus(), (t.lastStart = Object(u.a)()), (t.clicking = !0));
          }),
          C(t, "select", "click", function (n) {
            (t.directSelect && n.target !== e) ||
              ((Object(u.a)() - t.lastStart > 500 && !0 === t.clicking) ||
                ((function (t, e) {
                  t.enableDoubleClick &&
                    (Object(u.a)() - t.lastClick < 300
                      ? (T(t, i.r, e), (t.lastClick = 0))
    ...
    var O = {
      ...
      over: function (t) {
        (d || p) &&
          C(t, i.Z, d ? "pointerover" : "mouseover", function (e) {
      ...
      out: function (t) {
        if (d) {
          ...
          p &&
            C(t, i.Y, "mouseout", function (e) {
              T(t, i.Y, e);
            });
      },
      move: function (t) {
        (d || p) &&
          C(t, i.W, d ? "pointermove" : "mousemove", function (e) {
  ...
  function (t, e, n) {
    ...
    function s(t) {
      return (
        r ||
        (((navigator.requestMediaKeySystemAccess && window.MediaKeySystemAccess.prototype.getConfiguration) ||
          window.MSMediaKeys) &&
        Object(i.a)(t)("drm")
  ...
  function (t, e, n) {
    ...
    e.a = {
      ...
      errors: {
        ...
        cantPlayVideo: "This video file cannot be played, please try another server",
        ...
        if (t === Object(t))
          for (var e = i.a.length, n = 0; n < e; n++) {
            ...
            if (this.providerSupports(r, t))
              return { priority: e - n - 1, name: r.name, type: t.type, providerToCheck: r, provider: o.a[r.name] };
          }
        return {};
      },
    });
        ...
        for (var a = [], c = 0; c < Object(r.c)(e); c++) {
          ...
          if ("media" === s.prefix) {
            ...
            switch (Object(r.b)(s).toLowerCase()) {
              case "content":
                if (
                  (Object(i.j)(s, "duration") && (n.duration = Object(i.g)(Object(i.j)(s, "duration"))),
                  Object(i.j)(s, "url"))
                ) {
                  n.sources || (n.sources = []);
                  var l = {
  ...
  function (t, e, n) {
    ...
    e.b = function (t, e) {
      ...
      var k,
        C,
        P = parseFloat(v.bandwidthEstimate),
        x = parseFloat(v.bitrateSelection);
      return (
        (v.bandwidthEstimate = Object(r.z)(P)
          ? P
    ...
    function m(t, e) {
      var n = "file:" === window.location.protocol ? "https:" : "",
        r = {
          ...
          googima: e
            ? "//ssl.p.jwpcdn.com/player/v/8.21.1/googimanvmp.js"
            : "//ssl.p.jwpcdn.com/player/plugins/googima/v/8.9.0/googima.js",
            ...
            (j = Object(r.j)(
              {
                ...
                logo: { position: "control-bar", file: p.a },
              },
              o.a,
              Object(r.C)(j, ["analytics", "aspectratio", "base", "file", "height", "playlist", "sources", "width"]),
            )),
          (j.key = w),
          (j.edition = k),
          (j.error = O.error()),
            ...
            var e = t.get("controls"),
              ...
              i = (function (t, e) {
                ...
                if (Array.isArray(n) && n.length)
                  for (
                    var r = Object(O.f)(t.get("item"), n.length), i = Object(O.c)(Object(w.a)(n[r]), t), o = 0;
                    o < i.length;
                    o++
                  )
  ...
  function (t, e, n) {
    ...
    function i(t) {
      return "hls" === t.type && r.OS.android
        ? !1 !== t.androidhls && !r.Browser.firefox && parseFloat(r.OS.version.version || "0") >= 4.4
        : null;
    }
  },
  function (t, e, n) {
